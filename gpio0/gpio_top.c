...
static uint64_t gpio_top_read(void *opaque, hwaddr addr, unsigned size)
{
    ...
    case 0x00:  /* ri_gpio_raw_int_status */
        ...
        break;
    case 0x04:  /* gpio_raw_int_status */
        value = s->gpio_raw_int_status;
        break;
    case 0x08:  /* gpio_int_level_sync */
        value = s->gpio_int_level_sync;
        break;
    case 0x0c:  /* ri_gpio_int_type */
        value = s->ri_gpio_int_type;
        break;
    case 0x10:  /* gpio_int_en_wen */
        value = s->gpio_int_en_wen;
        break;
    case 0x14:  /* ri_gpio_sw_data */
        value = s->ri_gpio_sw_data;
        break;
    case 0x18:  /* gpio_int_pol */
        value = s->gpio_int_pol;
        break;
    case 0x1c:  /* gpio_int_clk_en */
        value = s->gpio_int_clk_en;
        break;
    case 0x20:  /* gpio_debounce_wen */
        value = s->gpio_debounce_wen;
        break;
    case 0x24:  /* gpio_ext_data */
        value = s->gpio_ext_data;
        break;
    case 0x28:  /* gpio_int_level_sync_wen */
        value = s->gpio_int_level_sync_wen;
        break;
    case 0x2c:  /* gpio_int_type */
        value = s->gpio_int_type;
        break;
    case 0x30:  /* gpio_int_clr */
        value = s->gpio_int_clr;
        break;
    case 0x34:  /* int_k */
        value = gpio_top_get_int_k(s);
        break;
    case 0x38:  /* SUPPORT_INT_LEVEL_SYNC_PROC.int_level_sync_in_ff2 */
        value = s->SUPPORT_INT_LEVEL_SYNC_PROC_int_level_sync_in_ff2;
        break;
    case 0x3c:  /* ri_gpio_debounce */
        value = s->ri_gpio_debounce;
        break;
    case 0x40:  /* prdata */
        value = s->prdata;
        break;
    case 0x44:  /* ri_gpio_int_level_sync */
        value = s->ri_gpio_int_level_sync;
        break;
    case 0x48:  /* gpio_int_clr_wen */
        value = s->gpio_int_clr_wen;
        break;
    case 0x4c:  /* gpio_int_status_edge */
        value = s->gpio_int_status_edge;
        break;
    case 0x50:  /* ri_gpio_int_en */
        value = s->ri_gpio_int_en;
        break;
    case 0x54:  /* gpio_sw_data */
        value = s->gpio_sw_data;
        break;
    case 0x58:  /* int_edge_out */
        value = s->int_edge_out;
        break;
    case 0x5c:  /* gpio_int_mask_wen */
        value = s->gpio_int_mask_wen;
        break;
    case 0x60:  /* gpio_sw_dir */
        value = s->gpio_sw_dir;
        break;
    case 0x64:  /* ri_gpio_sw_dir */
        value = s->ri_gpio_sw_dir;
        break;
    case 0x68:  /* gpio_int_pol_wen */
        value = s->gpio_int_pol_wen;
        break;
    case 0x6c:  /* SUPPORT_INT_LEVEL_SYNC_PROC.int_level_sync_in_ff1 */
        value = s->SUPPORT_INT_LEVEL_SYNC_PROC_int_level_sync_in_ff1;
        break;
    case 0x70:  /* gpio_int_status_level */
        value = s->gpio_int_status_level;
        break;
    case 0x74:  /* ri_gpio_int_mask */
        value = s->ri_gpio_int_mask;
        break;
    case 0x78:  /* int_level_ff1 */
        value = s->int_level_ff1;
        break;
    case 0x7c:  /* gpio_rx_data_int */
        value = s->gpio_rx_data_int;
        break;
    case 0x80:  /* ri_gpio_int_pol */
        value = s->ri_gpio_int_pol;
        break;
    case 0x84:  /* gpio_int_mask */
        value = s->gpio_int_mask;
        break;
    case 0x88:  /* gpio_int_en */
        value = s->gpio_int_en;
        break;
    case 0x8c:  /* unnamed */
        value = s->unnamed;
        break;
    case 0x90:  /* debounce_d2 */
        value = s->debounce_d2;
        break;
    case 0x94:  /* gpio_sw_data_wen */
        value = s->gpio_sw_data_wen;
        break;
    case 0x98:  /* ri_gpio_int_status */
        value = s->ri_gpio_int_status;
        break;
    case 0x9c:  /* gpio_int_type_wen */
        value = s->gpio_int_type_wen;
        break;
    case 0xa0:  /* int_level_sync_in */
        value = s->int_level_sync_in;
        break;
    case 0xa4:  /* gpio_sw_dir_wen */
        value = s->gpio_sw_dir_wen;
        break;
    case 0xa8:  /* gpio_debounce */
        value = s->gpio_debounce;
        break;
    case 0xac:  /* ri_gpio_ext_data */
                              ...
                              uint64_t value, unsigned size)
{
    ...
    case 0xac:  /* ri_gpio_ext_data */
        ...
        break;
    case 0xb0:  /* dbclk (input) */
        s->dbclk = value;
        break;
    case 0xb4:  /* dbclk_rstn (input) */
        s->dbclk_rstn = value;
        break;
    case 0xb8:  /* gpio_ext_porta (input) */
        s->gpio_ext_porta = value;
        break;
    case 0xbc:  /* gpio_in_data (input) */
        s->gpio_in_data = value;
        break;
    case 0xc0:  /* gpio_int_status (input) */
        s->gpio_int_status = value;
        break;
    case 0xc4:  /* gpio_rx_data (input) */
        s->gpio_rx_data = value;
        break;
    case 0xc8:  /* paddr (input) */
        s->paddr = value;
        break;
    case 0xcc:  /* pclk (input) */
        s->pclk = value;
        break;
    case 0xd0:  /* pclk_int (input) */
        s->pclk_int = value;
        break;
    case 0xd4:  /* pclk_intr (input) */
        s->pclk_intr = value;
        break;
    case 0xd8:  /* penable (input) */
        s->penable = value;
        break;
    case 0xdc:  /* presetn (input) */
        s->presetn = value;
        gpio_top_on_presetn_write(s, value);
        break;
    case 0xe0:  /* psel (input) */
        s->psel = value;
        break;
    case 0xe4:  /* pwdata (input) */
        s->pwdata = value;
        break;
    case 0xe8:  /* pwrite (input) */
        s->pwrite = value;
        break;
    case 0xec:  /* scan_mode (input) */
        s->scan_mode = value;
        break;
    default:
